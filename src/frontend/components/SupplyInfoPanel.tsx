...
const SupplyInfoPanel: React.FC<SupplyInfoProps> = ({
  ...
  return (
    <div className="flex flex-col text-white p-6 rounded-xl shadow-md max-w-3xl w-full space-y-6">
      <h2 className="text-xl font-semibold">Reserve status & configuration</h2>
      ...
      <div className="flex flex-row items-center justify-start gap-6">
        ...
        <div className="border-l border-gray-700 h-1/2"></div>
