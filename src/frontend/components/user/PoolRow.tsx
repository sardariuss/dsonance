  ...
  return (
    <div className="py-2 h-[60px] sm:h-[68px] flex items-center">
      <div
        ...
        onClick={() => {
          navigate(`/pool/${position.YES_NO.pool_id}`);
        }}
      >
        <img
        ...
        <div className="flex flex-col space-y-0.5 sm:space-y-1 min-w-0 pl-1">
          ...
          <div className="flex">
            <ChoiceView choice={toEnum(position.YES_NO.choice)} />
          </div>
        </div>
      </div>
    </div>
