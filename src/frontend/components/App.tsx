...
const MobileWarning = () => (
  <div className="flex flex-col min-h-screen w-full bg-white dark:bg-slate-900 dark:border-gray-700 border-gray-200 dark:text-white text-black items-center justify-center space-y-10">
